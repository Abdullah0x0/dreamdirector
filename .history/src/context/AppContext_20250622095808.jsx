...
const loadPersistedState = () => {
  try {
    ...
    if (savedState) {
      ...
      // Clear old media files to prevent 404 errors
      // Only keep story data, not media URLs from previous sessions
      return {
        ...parsed,
        generatedImages: [], // Clear old images
        generatedVideos: [], // Clear old videos  
        generatedMusic: [], // Clear old music
